...
```bash
git clone https://github.com/keller-tobias/python-data-prep-whu
```
...
```powershell
# cd path/to/python-data-prep-whu # if not already in the project directory
...
cd 'path/to/python-data-prep-whu'
